...
const ExamRegistrationengineering = () => {
  const backendUrl = import.meta.env.VITE_BACKEND_URL;
  const { tokens, refreshtokens, userData, studentData } =
    useContext(AuthContext);
  const location = useLocation();
  const navigate = useNavigate();

  const checkedValue = location.state?.value || "";
  ...
  console.log("studentdata from exam", studentData);

  console.log("token from 1", tokens);
  console.log("reftoken from 1", refreshtokens);
  ...
  const price1 = course.find((course) => course.course_code == "ENG001");
  const price2 = course.find((course) => course.course_code == "ENG002");
  const price3 = course.find((course) => course.course_code == "ENG003");
  const price4 = course.find((course) => course.course_code == "ENG004");

  console.log("gjhgerh ", course);
    ...
    <>
      ...
      <div className="relative p-4 rounded-lg w-full mt-[2vw]">
        ...
        <img
          ...
          alt="Watermark"
          className="absolute inset-0 md:w-full md:h-[25vw] object-contain  mix-blend-multiply"
        />

        {/* Content */}
        <h2 className="text-lg font-bold mb-3 relative">
          Engineering Registration & Exam Dates
        </h2>
                    ...
                    <>
                      <label className="text-lg">
                        ...
                        <input
                          ...
                          checked={courseCode.includes("ENG001")}
                    ...
                    <>
                      <label className="text-lg">
                        ...
                        <input
                          ...
                          value="ENG002"
                          onChange={handleCourseCode}
                          checked={courseCode.includes("ENG002")}
                          className="mr-2 ml-[1vw]"
                        />
                      </label>
                    </>
                    ...
                    <>
                      <label className="text-lg">
                        ...
                        <input
                          ...
                          value="ENG003"
                          onChange={handleCourseCode}
                          checked={courseCode.includes("ENG003")}
                          className="mr-2 ml-[1vw]"
                        />
                      </label>
                    </>
                    ...
                    <>
                      <label className="text-lg">
                        ...
                        <input
                          ...
                          value="ENG004"
                          onChange={handleCourseCode}
                          checked={courseCode.includes("ENG004")}
                          className="mr-2 ml-[1vw]"
                        />
                      </label>
                    </>
        ...
        {courseCode.length > 0 && (
          <>
            <div className="md:w-[28vw] bg-white p-4 rounded-lg shadow-md">
              {/* <span className="italic text-red-500 text-[0.7vw]">* Once Promo code applied cannot be changed!</span> */}
              {/* Promo Code Section */}
              <div
              ...
              >
                <input
                  // disabled={couponsucess.valid && coupon ? true : false}
                  value={coupon}
...
export default ExamRegistrationengineering;
